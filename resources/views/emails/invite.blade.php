        ...
        <div style="border: solid 1px #cccc; border-radius: 1.2rem; background-color: #fff; ">
            <table
                ...
                <tr style="width: 100%;">
                    <th style="width: 50%; text-align: start;">
                        <h3 style="font-weight: bold;font-size: 2vw;">
                            {{ $meeting->title }}
                            @if ($meeting->status == 2)
                            - (Cancelled)
                            @endif
                        </h3>
                        <p style="font-size: 1.8vw; color: #fff !important">
            ...
            <div>
                    ...
                    <tr style="width: 100%;">
                        <th style="text-align: end; padding-top: 0.5%;width: 50%;">
                            <a href="{{ $meeting->google_meet_link }}"
                                ...
                                <span style="vertical-align: middle;font-size: 1.8vw;">
                                    Open in Google Meet
                                </span>
                            </a>
                        </th>
                ...
                <div style="padding: 0rem 1rem;">
                    <p style="font-weight: bold; margin: 0;font-size: 2vw; color: #022537 !important">Invited Persons
                    </p>
                    <p style="margin-top: 3px;font-size: 2vw; color: #0225378A !important">Invited persons by email or
                        Name
                    </p>
                    <div
                        ...
                        <p style=" font-weight: bold; margin: 0.3rem; font-size: 2vw;">
                        ...
                        <table style="font-weight: bold; width: 100%; padding: 0;">
                            <tr>
                                ...
                                <th style="width: 50%; text-align: end;">
                                    <p style="margin-top: 0;font-size: 2vw;">
                ...
                <div style="padding: 1rem;">
                    <p style="font-weight: bold; margin: 0;font-size: 2vw; color: #022537 !important">Meeting
                        Information
                    </p>
                    <p style="margin-top: 3px;font-size: 2vw; color: #0225378A !important">Type here the meeting info
                    </p>
                    <div
                        style="border: solid 1px #cccc; border-radius: 1.2rem; padding: 1rem; color: #022537; background-color: #fff;">
                        <table style="font-weight: bold; width: 100%; padding: 0;">
                            <tr>
                                <th style="text-align: start; vertical-align: baseline;width: 9px; font-size: 2vw">
                ...
                border-radius: 0 0 19px ;">
                    <p style="font-weight: bold; margin: 0;font-size: 2vw; color: #022537 !important">Meeting Room
                        Specs </p>
                    <p style="margin-top: 3px;font-size: 2vw; color: #0225378A !important">here the meeting room
                        info</p>
                    <table style="font-weight: 500; width: 100%; padding: 0;">
                        <tr>
                            <th style="text-align: start; vertical-align: baseline; float: inline-start; width: 42%;">
                                ...
                                <div
                                    style="border: solid 1px #cccc; border-radius: 1.2rem; padding: 1rem; color: #022537; width: 63%;height: fit-content; background-color: #fff; float: inline-end; font-size: 2vw">
                                    @foreach ($meeting->room->features as $feature)
                                    @if ($feature->name == 'wifi' && $feature->value)
                                    <p style="font-weight: 500; margin: 0.2rem 0.2rem;">
                                        <img src="https://safavisa.sirv.com/Images/wi-fi%201.png" alt="" srcset=""
                                            style="width: 15%;max-width: 20px;">
                                        <span
                                    ...
                                    <p style="font-weight: 500; margin: 0.2rem 0.2rem;">
                                        <img src="https://safavisa.sirv.com/Images/online-meeting%201.png" alt=""
                                    ...
                                    <p style="font-weight: 500; margin: 0.2rem 0.2rem;">
                                        <img src="https://safavisa.sirv.com/Images/television%201.png" alt="" srcset=""
                                            style="width: 15%;max-width: 20px;">
                                        <span
                                            style="font-weight: 500; color:rgb(126,126,126); vertical-align: text-bottom;">
                                            Projector
                            ...
                            <th
                                style="text-align: start; vertical-align: baseline; float: inline-start; width: 48%; font-size: 2vw;">
                                <div
