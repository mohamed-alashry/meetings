<div>
    <div class="row p-3 align-items-center justify-content-center">
        ...
        <div class="col-lg-9 col-sm-12 row d-flex gap-3 justify-content-center">
            ...
            <button type="button" class="btn my-3 shadow text-white rounded-4 fw-bold col-4"
                ...
                <svg class="mx-2" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 row gap-3 justify-content-end" wire:loading.remove>
                @if ($meeting->repeatable != 1)
                <button type="button" class="btn my-3 shadow text-white rounded-4 fw-bold col-lg-5 col-md-12 col-sm-12"
        ...
        <div class="modal-dialog ps-2 d-flex justify-content-end" style="max-width: 75%;">
            <div class="modal-content rounded-4" style="height: fit-content;">
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="row col-12 justify-content-center px-3">
                                            ...
                                            <div class="image-hover-text-container">
                                                <div class="image-hover-image">
                                                    <a href="{{ asset($photo->file_name) }}" target="_blank">
                                                        <img class="img-fluid rounded-5" style="height: 80px;"
                ...
                <div class="form-check form-check-inline m-3 w-100 text-center">
                    <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" wire:model='update_all' value="true">
                        Update All
                    </label>
                </div>
                @endif
