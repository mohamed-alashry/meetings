                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <div class="line-bookings row mt-3">
                            ...
                            <span class="col-lg-3 col-md-6 col-sm-12">
                                <a href="{{ route('meetings.calendar_view') }}"
                                    class="btn text-light w-100 h-100 rounded-4 py-3" style="background-color: #C2203D;">
                        ...
                        <div class="line-cards mt-4">
                            <div class="row">
                                @forelse ($meetings->take(8) as $meeting)
                                    @livewire('meetings.card', ['meeting' => $meeting, 'room' => $meeting->room], key('card-' . $meeting->id))
                                @empty
                                    <div class="card m-2 rounded-3">
                                        <div class="card-body p-5 m-4 m-auto">
                                            <h4 class="card-title">Not Found Upcoming Meetings</h4>
