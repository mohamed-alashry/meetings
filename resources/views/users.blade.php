...
<section class="section-contct-body">
    <div class="container-fluid">
        @livewire('users.index', ['users' => $users], key('users'))
        {{-- <div class="row">
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="post" class="w-100 px-2">
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="input-form-login px-lg-2 p-0 col-xl-6 col-sm-12">
                                                    <i class="fa-solid fa-lock icon fa-lg mt-3"></i>
                                                    <input class="input-field form-control my-3 px-5 py-3 rounded-4 shadow-sm" placeholder="password confirmation" type="password">
                                                </div>
